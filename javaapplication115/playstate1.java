...
public class playstate1 extends JPanel implements ActionListener{
	...
	private final ImageIcon imgstate2 = new ImageIcon(this.getClass().getResource("field2.jpg"));
        ...
        // losing //
	private final ImageIcon imgmeleon = new ImageIcon(this.getClass().getResource("cactus.png"));
...
//                   g.drawImage(img_paralyze.getImage(), m.x, 550,100,150, this);
		...
		g.setColor(Color.WHITE);
		g.drawString("HP2 =  "+HP2,80, 100);	     
		g.setFont(new Font("Hobo Std",Font.HANGING_BASELINE,50));
		g.drawString("STATE "+rs2,420,80);    
